...
<%
	...
	guestList.add(new Guest(10, "KIM", "2022/03", "guard1@email.com", "http://www.google.com", "타이틀10", "컨텐트10"));
	guestList.add(new Guest(20, "JIM", "2022/07", "guard2@email.com", "http://www.google.com", "타이틀20", "컨텐트20"));
	guestList.add(new Guest(30, "MIM", "2022/09", "guard3@email.com", "http://www.google.com", "타이틀30", "컨텐트30"));
	...
	/*
	속성객체(attribute)객체
		- 속성객체 이름 a, b, c, d, e, f, gueset, user, guestList, guestMap
	*/
...
<ul>
	...
	<li>----------------JSP, service안에 선언된 local 변수----------------------------</li>
	<li><%=str1%></li>
	<li><%=int1%></li>
