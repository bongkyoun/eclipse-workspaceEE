...
<body>
	...
	<ul>
		...
		<li>${string1}${string2}</li> <!--String은 +연산 불가-->
		<li>${"123"+"456"+"7"}</li>
		...
		<li>age gte 30--> ${age ge 30}</li>
		<li>age lt 30--> ${age lt 30}</li>
		<li>age lte 30--> ${age le 30}</li>
		<li>age eq 30--> ${age eq 30}</li>
		<li>30대인가요? ${age>=30 && age<40}</li>
		<li>30대가 아닌가요? ${!(age>=30 && age<40)}</li>
		<li>30이고 키가 180이상인가요? ${(age>=30 && age<40) && height>=180} </li>
		<li>30이고 키가 180이상인가요? ${(age ge 30 and age lt 40) and height ge 180} </li>
		...
		<li>------------null or size 체크(empty 연산자)-----------------</li>
		<li>${empty guest}</li>
