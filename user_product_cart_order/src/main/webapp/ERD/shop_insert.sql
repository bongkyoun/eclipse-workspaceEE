...
/**********************cart insert************************/
--로그인한 guard1님의 카트에 존재하지 않는 제품을 카트에 담기
...
--로그인한 guard2님의 카트에 존재하지 않는 제품을 카트에 담기
...
insert into orders(o_no, o_desc, o_date, o_price, userid) values(orders_o_no_seq.nextval, '비글 외 1종', sysdate, 1550000, 'guard1');
...
insert into orders(o_no, o_desc, o_date, o_price, userid) values(orders_o_no_seq.nextval, '닥스훈트 외 1종', sysdate, 2400000, 'guard1');
...
insert into orders(o_no, o_desc, o_date, o_price, userid) values(orders_o_no_seq.nextval, '비글 외 1종', sysdate, 1650000, 'guard2');
insert into order_item(oi_no, oi_qty, o_no, p_no) values(order_item_oi_no_seq.nextval, 1, orders_o_no_seq.currval, 1);
commit;
