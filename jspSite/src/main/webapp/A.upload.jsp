...
*/
	...
	/*
		- DefaultFileRenamePloicy : 똑같은 이름을 가진 파일이 존재한다면 파일명(숫자) 1, 2, 3..을 붙여서 저장해주는 클래스
		- FileRenamePolicy		  : 똑같은 이름을 가진 파일이 존재한다면 사용자가 만든 이름을 적용시킬 수 있게 해주는 클래스
	*/
	MultipartRequest multipartReqeust = 
	...
	*/
	String name = multipartReqeust.getParameter("name");
	String fileone = multipartReqeust.getFilesystemName("fileone");
	String filetwo = multipartReqeust.getFilesystemName("filetwo");
%>
<h1>Upload Data</h1>
<hr/>
<br/>
